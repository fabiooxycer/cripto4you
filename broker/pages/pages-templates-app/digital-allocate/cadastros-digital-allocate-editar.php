...
if (!empty($_POST)) {
    ...
    echo '<script>setTimeout(function () { 
      ...
      function(isConfirm){
        if (isConfirm) {
          window.location.href = "estatisticas-digital-allocate";
        }
      }); }, 1000);</script>';
}
?>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">DIGITAL ALLOCATE</h6>
            <h6 class="m-0 font-weight-bold text-primary">EDITAR - AGENTE EXECUTIVO - CÓD. <font color="blue"><?php echo $data['meu_id']; ?></font></h6>
            <p class="mb-4">Favor conferir e preencher todos os campos.</p>
        </div>
        <div class="card-body">
            <form action="cadastros-digital-allocate-editar?id=<?php echo $id ?>" method="post">
                <div class="px-3">
                    <div class="form-body">
