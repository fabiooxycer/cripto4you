...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Estatísticas Digital Intelligentia</h1>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            $total = 0;
                            $n = 1;
                            $sql = 'SELECT count(*) as t FROM tbl_cadastros WHERE empresa = "3" AND atuacao = "1" AND status="1"';
                            $sql = $pdo->query($sql);
                            $sql = $sql->fetch();
                            $total_aen = $sql['t'];
                            ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            $total = 0;
                            $n = 1;
                            $sql = 'SELECT count(*) as t FROM tbl_cadastros WHERE empresa = "3" AND atuacao = "2" AND status="1"';
                            $sql = $pdo->query($sql);
                            $sql = $sql->fetch();
                            $total_aem = $sql['t'];
                            ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            $total = 0;
                            $n = 1;
                            $sql = 'SELECT count(*) as t FROM tbl_cadastros WHERE empresa = "3" AND atuacao = "5" AND status="1"';
                            $sql = $pdo->query($sql);
                            $sql = $sql->fetch();
                            $total_aee = $sql['t'];
                            ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            $total = 0;
                            $n = 1;
                            $sql = 'SELECT count(*) as t FROM tbl_cadastros WHERE empresa = "3" AND atuacao = "6" AND status="1"';
                            $sql = $pdo->query($sql);
                            $sql = $sql->fetch();
                            $total_aeem = $sql['t'];
                            ?>
