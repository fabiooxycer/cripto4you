            ...
            <ul class="navbar-list">
                <li class="line-height">
                    <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                        <img src="assets/images/user/perfil.jpg" class="img-fluid rounded mr-3" alt="<?php echo $_SESSION['UsuarioNome']; ?>">
                    </a>
                        ...
                        <div class="iq-card shadow-none m-0">
                            <div class="iq-card-body p-0 ">
                                <div class="bg-primary p-3">
                                    ...
                                    <span class="text-white font-size-12">Olá <?php echo $_SESSION['UsuarioNome']; ?></span>
                                </div>
                                <a href="perfil" class="iq-sub-card iq-bg-primary-hover">
                                    <div class="media align-items-center">
                                ...
                                <div class="d-inline-block w-100 text-center p-3">
                                    <a class="bg-primary iq-sign-btn" href="sair" role="button">Sair<i class="ri-login-box-line ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
