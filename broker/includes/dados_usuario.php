            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <?php
                        $sql = $pdo->query('SELECT  sum(valor) FROM tbl_investimentos WHERE id_usuario = "' . $_SESSION['UsuarioID'] . '" AND tipo = 3 AND confirmado = 1 AND reinvestir = 1');
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        foreach ($result as $reinvestir) {
                            $valor_reinvestir = $reinvestir['sum(valor)'] - $retiradas;
                        }
