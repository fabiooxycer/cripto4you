<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 mb-0 text-gray-800">TOTAL DE MOVIMENTAÇÕES CRIPTO4YOU</h1>
</div>
<div class="row">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        ?>
                            ...
                            <p>
                                <font size="1">Valor total movimentado não reinvestidos</font>
                            </p>
                        <?php } ?>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        ?>
                            ...
                            <p>
                                <font size="1">Valor total movimentado</font>
                            </p>
                        <?php } ?>
                    </div>
                    <div class="col-auto">
