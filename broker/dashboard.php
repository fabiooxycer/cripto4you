            ...
            <div class="col-lg-12 text-center">
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    ...
                    <p style="margin-left: 10px; margin-right: 10px;">
                        ...
                        <font color="#36D900" size="3"><br><strong>ATENÇÃO!</strong> <i><br>Função saque desativada devido a queda do mercado cripto. Estamos aguardando recuperação do mesmo para finalizar as operações realizadas em 11/05/2022, onde até o momento estamos com -36% negativo. Mercado vem se recuperando desde ontem, onde ainda estamos recuperando os -36%. Vamos manter nossa análise e operar somente com segurança e se tiver estabilidade, vendo que esse mercado é influenciado por notícias, comentários e tecnologia. Vamos manter a calma e aguardar mais um pouco para evitarmos possíveis percas.<br>Pedimos um pouco de paciência para todos os investidores, e assim que o mercado se estabilizar, vamos liberar todas as funções de nossa plataforma.<br>Obrigado(a)!<br>Equipe Cripto4You</i></font><br>
                    </p>
                </div>
            </div>
